<div>
    ...
    <div class="flex items-center justify-between pb-4 bg-white ma-3 dark:bg-gray-900">
        ...
        <div class="justify-self-auto">
            @can('Ver CrearRoles')
            <button wire:click="newAdd()"
                class="relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800"
                type="button">
                <span
                    class="block relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                    Crear nuevo
                </span>
            </button>
            @endcan
    ...
    <div class="relative shadow-md sm:rounded-lg">
        <x-table
            ...
            editPermission="Ver EditarRoles"
            deletePermission="Ver EliminarRoles"
        />
    </div>
    <div>
        @include('livewire.settings.roles.form')
    </div>
